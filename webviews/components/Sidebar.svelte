...
{#if screen == Page.home}
    ...
    {#each results as result}
        <h3>
            {result.title}
            {#if result.is_answered}<span style="color: teal;">&#10004;</span
                >{/if}
        </h3>
...
{:else if screen == Page.ask}
    ...
    <p style="font-weight: 300;">
        ...
        />
        You can use the <b>Insert code from current selection</b> command to append
        your code to the body of the question
    </p>
{/if}
